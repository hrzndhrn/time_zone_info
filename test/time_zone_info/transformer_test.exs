defmodule TimeZoneInfo.TransformerTest do
  ...
  describe "transform/1" do
    ...
    test "returns transformed data for time zone America/Godthab", %{data: data} do
      assert_time_zone(data, "America/Godthab", [
        [
    ...
    test "returns transformed data for time zone Europe/Oslo", %{data: data} do
      assert_time_zone(data, "Europe/Oslo", [
        [
          {~N[1944-04-03 01:00:00], {3600, 3600, "CEST"}},
          {~N[1943-10-04 01:00:00], {3600, 0, "CET"}},
          {~N[1943-03-29 01:00:00], {3600, 3600, "CEST"}},
